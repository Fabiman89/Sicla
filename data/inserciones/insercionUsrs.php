...
mysqli_query($mysqli,"INSERT INTO user (nombreUsuario,apellidoUsuario,correo,password,idTipoUsr) VALUES ('$nombre', '$apellido', '$correo','$password',4)"); // query qe inserta
