...
$scope.checkStates = function(value,q){
    console.log(q);
switch(q){
    case 1: 
                if(value==0){
                ...
                if(value==1){
                    $scope.reporte.medio= {"nombreMedio":"Sin Considerar","idMedio":01};
                }        
    break;
    case 2:
                 if(value==0){
                    $scope.reporte.tipoNota= {"nombreAutor":"Sin Considerar","idAutor":0};
                }
                if(value==1){
                    $scope.reporte.tipoNota= {"nombreAutor":"Sin Considerar","idAutor":01};
                }  
    break;
    case 3:
                 if(value==0){
                    $scope.reporte.autor= {"nombreTipoNota":"Sin Considerar","idTipoNota":0};
                }
                if(value==1){
                    $scope.reporte.autor= {"nombreTipoNota":"Sin Considerar","idTipoNota":01};
                }  
        break;
    case 4:
                 if(value==0){
                ...
                if(value==1){
                    $scope.reporte.autor= {"nombreAutor":"Sin Considerar","idAutor":01};
                }  
        break;    
        break;
    case 5:
